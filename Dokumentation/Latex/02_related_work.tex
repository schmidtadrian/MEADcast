...
% paragraph Addressing (end)

\paragraph{Group Management} % (fold)
...
% paragraph Group Management (end)

\paragraph{Routing} % (fold)
\label{par:Routing}
...
% paragraph Routing (end)

\paragraph{Forwarding} % (fold)
...
% paragraph Protocols (end)

% paragraph Forwarding (end)
