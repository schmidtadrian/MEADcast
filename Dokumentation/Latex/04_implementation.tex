...
\multirow{2}{*}[-4pt]{\textbf{\makecell[c]{Use\\case}}} & &
\multicolumn{2}{c}{Clients} & &
\multirow{2}{*}[-4pt]{\makecell[c]{Net.\\Supp.}} &
...
% started with one client per router and scaled up
...
%   - various sender configurations
%   - various network support levels
