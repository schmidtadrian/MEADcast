...
\bitheader{0-31} \\
    ...
    \wordbox[lrb]{1}{} \\
\end{bytefield}
\caption{\gls{mead} header specification}
...
Setting \inlinelst{min\_dsts} to 0 disables premature \gls{mead} to IP unicast
    transformation.
...
\begin{figure}
    \begin{center}
        \includegraphics[width=.8\textwidth]{testbed_topology.pdf}
    \end{center}
...
The chosen topology enables the measurement of \gls{mead}'s performance for
...
\subsubsection{UC3 Video conference} % (fold)
