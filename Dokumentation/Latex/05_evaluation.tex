...
\section{Experiment Conduction} % (fold)
\label{sec:Experiment Conduction}
% - More than 150 measurements, repeated multiple times to ensure validity of results
% - Gnu parallel, iperf, ifstat to measure data
% - Measured with and without discovery phase
% - Measured BW on all links on hypervisor
% - Why no P2P and online gaming
% - proved that MEADcast on/off flag has no impact
% - Where and how simulated firewall, routing change and link failure
%   - Sender: c1201
%   - Receivers: c33-c36 clients 1-3
%   - Once all MEADcast routers --> MEADcast Fallback
%   - Once r31, r310, r311 --> Unicast Fallback
...
% section Experiment Conduction (end)
